...
function Show-Menu {
    ...
    Write-Host "0: Precheck"
    # Write-Host "2: Add_vgpu"
    Write-Host "1: Config_vGpu"
    Write-Host "2: Remove_vGpu"
    Write-Host "3: Config_vGpuDriver(for nv gpu)"
    Write-Host "4: Remove_vGpuDriver(for nv gpu)"
    Write-Host "q: quit"
    Write-Host ""
    Write-Host "by zhaoyachuan@gmail.com"
    Write-Host ""
}
...
do {
    ...
    switch ($choice) {
        ...
        '1' { Config_vgpu }
        '2' { Remove_vGpu }
        '3' { Update_vGpuDriver -mode "add" }
        '4' { Update_vGpuDriver -mode "clear" }
